...
public class ProductDTO {
	...
	public String toString() {
		return "ProductDTO [product_code=" + product_code + ", product_name=" + product_name + ", product_cate="
				+ product_cate + ", product_brand=" + product_brand + ", product_price=" + product_price
				+ ", product_amount=" + product_amount + ", product_detail=" + product_detail + ", product_check="
				+ product_check + ", recommend=" + recommend + ", product_date=" + product_date + ", filename="
				+ filename + ", file1=" + file1 + ", product_saleprice=" + product_saleprice + ", product_saledate="
				+ product_saledate + "]";
	}
